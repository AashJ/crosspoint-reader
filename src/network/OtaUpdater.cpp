...
namespace {
#ifndef CROSSPOINT_OTA_REPOSITORY
#define CROSSPOINT_OTA_REPOSITORY "crosspoint-reader/crosspoint-reader"
#endif

constexpr char latestReleaseUrl[] = "https://api.github.com/repos/" CROSSPOINT_OTA_REPOSITORY "/releases/latest";
}  // namespace
...
bool OtaUpdater::isUpdateNewer() const {
  ...
  return firmware_version::isNewer(CROSSPOINT_VERSION, latestVersion.c_str());
}
